/**
 * Creates a new Function that will execute `func` when called (passing on any arguments). If the call to `func` fails, it will be retried up to `retryLimit` times.
